 ...
 */ async function fetchFragments() {
    const accessToken = await (0, _authJs.getAccessToken)();
    if (!accessToken) {
    ...
    try {
        ...
        } else console.error('Failed to fetch fragments:', response.statusText);
    } catch (error) {
...
document.getElementById('fetchFragmentsButton').addEventListener('click', fetchFragments);
// Handle OAuth redirect callback
(0, _authJs.handleRedirectCallback)();

},{"./auth.js":"lT1n0"}],"lT1n0":[function(require,module,exports,__globalThis) {
...
const config = {
    authority: `https://cognito-idp.us-east-1.amazonaws.com/${"us-east-1_eDcV69uiP"}`,
    client_id: "4frgh0meni7ohbk4d4mm0p8okn",
    redirect_uri: "http://localhost:1234",
    response_type: 'code',
    scope: 'openid email'
};
const userManager = new (0, _oidcClientTs.UserManager)(config);
...
},{"oidc-client-ts":"jXrpQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jXrpQ":[function(require,module,exports,__globalThis) {
"use strict";
...
},{"3455b80cc963b26":"EeAxo"}],"EeAxo":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
