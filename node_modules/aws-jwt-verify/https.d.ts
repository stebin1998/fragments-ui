 ...
 */
export declare const fetch: (uri: string, requestOptions?: Record<string, unknown>, data?: ArrayBuffer) => Promise<ArrayBuffer>;
...
export interface Fetcher {
     ...
     * @returns - The response body as ArrayBuffer
     */
    fetch: (uri: string, requestOptions?: FetchRequestOptions, data?: Buffer) => Promise<ArrayBuffer>;
}
/**
 ...
 */
export declare class SimpleFetcher implements Fetcher {
     ...
     * @returns - The response body as ArrayBuffer
     */
    fetch(uri: string, requestOptions?: FetchRequestOptions, data?: ArrayBuffer): Promise<ArrayBuffer>;
}
export {};
