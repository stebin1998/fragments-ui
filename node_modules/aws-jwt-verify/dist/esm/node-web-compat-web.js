...
import { FetchError, NotSupportedError, JwtInvalidSignatureAlgorithmError, NonRetryableFetchError, } from "./error.js";
/**
...
export const nodeWebCompat = {
    fetch: async (uri, requestOptions, data) => {
        ...
        if (response.status !== 200) {
            throw new NonRetryableFetchError(uri, `Status code is ${response.status}, expected 200`);
        }
